...
const QUICK_ACTIONS: QuickAction[] = [
  { icon: <MessageCircle className="w-3.5 h-3.5" />, label: '知识讲解', prompt: '用大白话生动形象地讲解这些笔记里的知识，用生活中的例子类比，让知识点变得通俗易懂' },
...
const SYSTEM_PROMPT = `你是用户的AI学习规划专家。

【核心能力】
1. 理解用户知识体系：分析用户笔记内容，理解用户的学习进度和知识体系
2. 推荐学习路径：根据用户已学的知识和学习目标，并结合该领域通用的学习路径，识别用户应该学哪些前置知识和下一步应该学习哪些知识。
3. 回答问题：基于用户笔记内容提供准确回答
4. 发现薄弱点：识别用户知识的盲点和不足
5. 知识讲解：用大白话生动形象地讲解笔记里的知识，让知识点变得通俗易懂
