...
>((
  ...
  const tooltipLabel = React.useMemo(() => {
    ...
    const value = labelFormatter ? labelFormatter(label, payload) : label
                    ...
                    !hideIndicator && (
                      <div
                        className={cn(
                          ...
                          indicator === "line" && "h-px w-2.5",
                          indicator === "dashed" && "h-px w-2.5 border-dashed"
                        )}
                        style={{
        ...
        return (
          ...
          >
            {itemConfig?.icon && !hideIcon ? (
              ...
              <div
                className="h-2 w-2 shrink-0 rounded-[2px] border-[--color] bg-[--color]"
                style={{
                  "--color": item.color,
                } as React.CSSProperties}
              />
...
// Re-export all recharts components to use throughout the app.
